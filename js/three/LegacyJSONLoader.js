        ...
        parse: (function () {
            function parseModel(json, geometry) {
                ...
                if (reset_pos) {
                    ...
                    // center the object
                    let v_offset = 0;
                    let v_Length = vertices.length;
                    while (v_offset < v_Length) {
                        vertices[v_offset] = vertices[v_offset] - xOffset;
                        v_offset++;
                        v_offset++;
                        vertices[v_offset] = vertices[v_offset] - zOffset;
                        v_offset++;
                    }
                }
                offset = 0;
            ...
            function parseMorphing(json, geometry) {
                ...
                if (json.morphTargets !== undefined) {
                    for (var i = 0, l = json.morphTargets.length; i < l; i++) {
                        ...
                        if (reset_pos) {
                            // center the morphTargets
                            let v_offset = 0;
                            let v_Length = srcVertices.length;
                            while (v_offset < v_Length) {
                                srcVertices[v_offset] = srcVertices[v_offset] - xOffset;
                                v_offset++;
                                v_offset++;
                                srcVertices[v_offset] = srcVertices[v_offset] - zOffset;
                                v_offset++;
                            }
                        }
